<?php
$data=array( "catatan1"=>"kehadiran>=70%",
...
<form id="reza" name="reza" method="post" action="nilaiakhir.php">
  <table width="350" border="1" align="center" bordercolor="#0000FF" bgcolor="#00A2E8">
	...
	<tr>
      ...
      <td>
		  <input type="checkbox" name="absen" value="<?php echo $data["catatan1"];?>"> Kehadiran >= 70% <br />
		  <input type="checkbox" name="absen" value="<?php echo $data["catatan2"];?>"> interaktif dikelas <br />
		  <input type="checkbox" name="absen" value="<?php echo $data["catatan3"];?>"> Tidak terlambat mengumpulkan tugas <br /></td>
    </tr>
  </table><br/>
